...
def main() -> None:
    ...
    try:
        ...
        for index in range(frame_count):
            ...
            observed_corrected = manager.get_stream(
                "ao_corrected_centroids"
            ).read()
            observed_flattened = manager.get_stream(
                "ao_flattened_slopes"
            ).read()
            observed_open_loop = manager.get_stream(
                "ao_open_loop_command"
            ).read()
