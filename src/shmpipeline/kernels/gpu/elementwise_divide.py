"""GPU elementwise division kernel."""
...
class ElementwiseDivideGpuKernel(GpuKernel):
    """Compute output = input / auxiliary elementwise."""

    kind = "gpu.elementwise_divide"
    auxiliary_arity = 1
    ...
    def compute_into(
        ...
        torch.div(as_gpu_tensor(trigger_input, device=self.device), rhs, out=output)
